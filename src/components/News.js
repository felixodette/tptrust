                    ...
                    <div className="col-lg-6 col-sm-6">
                        <div className="recent-item">
                            ...
                            <div className="news__content">
                                <h3 className="news__content-title"><Link href="/blog-item"><a>A place where start new
                                ...
                                <Link href="/blog-item"><a className="theme-btn">read more</a></Link>
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-6 col-sm-6">
                        <div className="recent-item">
                            <div className="recent__img">
                                ...
                                <img src="/assets/images/blog-img5.jpg" alt="service-image"/>
                            </div>
                            <div className="news__content">
                                <h3 className="news__content-title"><Link href="/blog-item"><a>We can make a difference
                    ...
                    <div className="col-lg-6 col-sm-6">
                        <div className="recent-item">
                            <div className="recent__img">
                                ...
                                <img src="/assets/images/blog-img6.jpg" alt="service-image" />
                            </div>
                            <div className="news__content">
                                <h3 className="news__content-title"><Link href="/blog-item"><a>Build school for poor
                                    childrens</a></Link></h3>
                                <ul className="news__content-list">
                    ...
                    <div className="col-lg-6 col-sm-6">
                        <div className="recent-item">
                            <div className="recent__img">
                                ...
                                <img src="/assets/images/blog-img7.jpg" alt="service-image" />
                            </div>
                            <div className="news__content">
                                <h3 className="news__content-title"><Link href="/blog-item"><a>Learn how access to clean
                                    water</a></Link></h3>
                                <ul className="news__content-list">
                    ...
                    <div className="col-lg-6 col-sm-6">
                        <div className="recent-item">
                            <div className="recent__img">
                                ...
                                <img src="/assets/images/blog-img8.jpg" alt="service-image" />
                            </div>
                            <div className="news__content">
                                <h3 className="news__content-title"><Link href="/blog-item"><a>Do something crazy to
                    ...
                    <div className="col-lg-6 col-sm-6">
                        <div className="recent-item">
                            <div className="recent__img">
                                ...
                                <img src="/assets/images/blog-img9.jpg" alt="service-image" />
                            </div>
                            <div className="news__content">
                                <h3 className="news__content-title"><Link href="/blog-item"><a>Together to help the
