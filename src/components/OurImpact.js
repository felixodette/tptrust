          ...
          <div className="col-lg-7">
            <div className="about-heading">
              <div className="section-heading">
                ...
                <a href={myJson.ourImpact[0].pdf} className="theme-btn" onClick={() => openPDFInFullScreen(myJson.ourImpact[0].pdf)}>Download Report</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-7">
            <div className="about-heading">
              <div className="section-heading">
                ...
                <a href={myJson.ourImpact[1].pdf} className="theme-btn" onClick={() => openPDFInFullScreen(myJson.ourImpact[1].pdf)}>Download Report</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-7">
            <div className="about-heading">
              <div className="section-heading">
                ...
                <a href={myJson.ourImpact[2].pdf} className="theme-btn" onClick={() => openPDFInFullScreen(myJson.ourImpact[2].pdf)}>Download Report</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-7">
            <div className="about-heading">
              <div className="section-heading">
                ...
                <a href={myJson.ourImpact[3].pdf} className="theme-btn" onClick={() => openPDFInFullScreen(myJson.ourImpact[3].pdf)}>Download Report</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-7">
            <div className="about-heading">
              <div className="section-heading">
                ...
                <a href={myJson.ourImpact[4].pdf} className="theme-btn" onClick={() => openPDFInFullScreen(myJson.ourImpact[4].pdf)}>Download Report</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-7">
            <div className="about-heading">
              <div className="section-heading">
                ...
                <a href={myJson.ourImpact[5].pdf} className="theme-btn" onClick={() => openPDFInFullScreen(myJson.ourImpact[5].pdf)}>Download Report</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-7">
            <div className="about-heading">
              <div className="section-heading">
                ...
                <a href={myJson.ourImpact[6].pdf} className="theme-btn" onClick={() => openPDFInFullScreen(myJson.ourImpact[6].pdf)}>Download Report</a>
              </div>
            </div>
          </div>
        </div>
