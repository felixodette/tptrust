            ...
            <div className="col-lg-6">
              <div className="helping-text-box">
                <p className="helping__text">
                  Many children around the world are born into poverty, without access to basic necessities like
                  education. By giving a helping hand to underprivileged children, you can
                  help provide them with support to break free from the cycle of poverty. Your generosity can provide
                  them with the tools they need to overcome challenges and build a brighter future.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-6">
              <div className="fun-content">
                <div className="fun-item fun-item1">
                  <img src="/assets/images/helping-img.jpg" alt=""/>
                </div>
